        ...
        <div class="container">
            <div class="pull-left auto-width-left">
                <ul class="top-menu menu-beta l-inline">
                    <li><a href=""><i class="fa fa-home"></i>90/92 Quốc Dương </a></li>
                    <li><a href=""><i class="fa fa-phone"></i> 0865 710 154</a></li>
                </ul>
            </div>
            <div class="pull-right auto-width-right">
                <ul class="top-details menu-beta l-inline">
                    @if (Auth::check())
                    <li><a href="{{route('admin.getLogout')}}"><i class="fa fa-user"></i>Chào bạn {{Auth::user()->full_name}}</a></li>
