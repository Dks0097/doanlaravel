            ...
            <table class="shop_table beta-shopping-cart-table" cellspacing="0"   >
                <thead>
                    <tr>
                        ...
                        <th class="product-subtotal">Save</th>
                ...
                <tbody >
                    ...
                    <tr class="cart_item">
                        <td class="product-name">
                            <div class="media">
                                ...
                                <div class="media-body">
                                    ...
                                    <a class="table-edit" href="{{route('banhang.addToCart',$product['item']->id)}}">Edit</a>
                                </div>
                            </div>
                        </td>
                        ...
                        <td>
                            ...
                            <button  onclick="SaveListItemCart({{$product['item']->id}})" title="Remove this item"> <i  
                        ...
                        <td class="product-remove">
                            <a onclick="DelListItemCart({{$product['item']->id}})" class="remove" title="Remove this item"><i class="fa fa-trash-o"></i></a>
                        </td>
                    </tr>
                    @endforeach
                    @endisset
                ...
                <tfoot>
                    <tr>
                        <td colspan="6" class="actions">
                            ...
                            <button type="submit" class="beta-btn primary edit-all" name="update_cart">Update Cart <i class="fa fa-chevron-right"></i></button> 
